...
import { X, Plus, Minus, Trash2, ShoppingBag, ArrowLeft, CreditCard } from 'lucide-react';
  ...
  return (
    <>
                  ...
                  <div key={item.id} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <button onClick={() => onUpdateQuantity(item.id, item.quantity - 1)} className="w-7 h-7 rounded-full border border-gray-300 dark:border-gray-600 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    ...
                    <button onClick={() => onRemove(item.id)} className="p-2 rounded hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-colors">
      ...
      <CheckoutModal
        ...
        onRemove={onRemove}
        onClearCart={() => cart.forEach(item => onRemove(item.id))}
        showToast={showToast}
      />
    </>
  );
